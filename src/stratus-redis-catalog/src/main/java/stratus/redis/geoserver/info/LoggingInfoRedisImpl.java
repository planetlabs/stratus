 ...
 * Created on 6/5/18
 */
@RedisHash("LoggingInfo")
public class LoggingInfoRedisImpl implements LoggingInfo, Serializable {

    private static final long serialVersionUID = -5707036700832930148L;
    String id;
    String level;
    String location;
