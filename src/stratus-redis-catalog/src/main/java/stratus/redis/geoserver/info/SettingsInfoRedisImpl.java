 ...
 * Created on 6/5/18
 */
@RedisHash("SettingsInfo")
public class SettingsInfoRedisImpl implements SettingsInfo, Serializable {

    private static final long serialVersionUID = -8898314430649262521L;
    protected String id;
    @Indexed protected String workspaceId;
    @Transient protected WorkspaceInfo workspace;
