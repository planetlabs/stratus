...
public class RedisGetMapIntegrationTest extends GetMapIntegrationTest {
    ...
    //This appears to be incompatible with spring-boot logging?
    @Override
    public void testLargerThanWorld() {}
}
