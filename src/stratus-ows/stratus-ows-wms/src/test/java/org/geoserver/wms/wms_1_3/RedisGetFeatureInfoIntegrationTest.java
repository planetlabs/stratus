...
public class RedisGetFeatureInfoIntegrationTest extends GetFeatureInfoIntegrationTest {
    ...
    //This works in isolation but not when run with other tests
    @Override
    public void testCustomTemplateManyRules() {}
}
