...
public class RedisCapabilitiesIntegrationTest extends CapabilitiesIntegrationTest {

    @Autowired
    private StratusWmsTestSupport stratusWmsTestSupport;

    @Override
    protected void onSetUp(SystemTestData testData) throws Exception {
        stratusWmsTestSupport.configureWmsTestPreSetup(applicationContext, getCatalog());
        super.onSetUp(testData);
        stratusWmsTestSupport.configureWmsTestPostSetup(applicationContext, getCatalog());
    }
}
