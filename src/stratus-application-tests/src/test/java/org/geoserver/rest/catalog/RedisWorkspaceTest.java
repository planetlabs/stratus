...
import stratus.redis.cache.rest.preloaders.WorkspacePreloader;
import stratus.redis.cache.rest.preloaders.WorkspacesPreloader;
...
@SpringBootTest(classes = {
        ...
        /* Cache preloaders */
        WebXmlConfig.class, RestCachingInterceptor.class, WorkspacePreloader.class, WorkspacesPreloader.class},
        properties = {"stratus.catalog.redis.caching.enable-rest-caching=true", "spring.main.allow-bean-definition-overriding=true"})
public class RedisWorkspaceTest extends WorkspaceTest {
