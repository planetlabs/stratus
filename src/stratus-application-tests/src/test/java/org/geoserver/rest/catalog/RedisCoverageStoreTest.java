...
import stratus.redis.cache.rest.preloaders.CoverageStorePreloader;
import stratus.redis.cache.rest.preloaders.CoverageStoresPreloader;
...
@SpringBootTest(classes = {
        ...
        /* Cache preloaders */
        WebXmlConfig.class, RestCachingInterceptor.class, CoverageStorePreloader.class, CoverageStoresPreloader.class},
        properties = {"stratus.catalog.redis.caching.enable-rest-caching=true", "spring.main.allow-bean-definition-overriding=true"})
public class RedisCoverageStoreTest extends CoverageStoreControllerTest {
    ...
    /* Mosaic tests currently disabled */
    @Override
    public void testPutEmptyAndHarvest() { }

    @Override
    public void testDeletePurgeMetadataAfterConfigure() { }

    @Override
    public void testDeletePurgeAllAfterConfigure() { }
