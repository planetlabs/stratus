...
import stratus.redis.cache.rest.preloaders.WmsStorePreloader;
import stratus.redis.cache.rest.preloaders.WmsStoresPreloader;
...
@SpringBootTest(classes = {
        ...
        /* Cache preloaders */
        WebXmlConfig.class, RestCachingInterceptor.class, WmsStorePreloader.class, WmsStoresPreloader.class},
        properties = {"stratus.catalog.redis.caching.enable-rest-caching=true", "spring.main.allow-bean-definition-overriding=true"})
public class RedisWMSStoreTest extends WMSStoreTest {
