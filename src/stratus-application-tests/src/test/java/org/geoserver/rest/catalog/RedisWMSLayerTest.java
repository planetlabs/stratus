...
import stratus.redis.cache.rest.preloaders.WmsLayerPreloader;
import stratus.redis.cache.rest.preloaders.WmsLayersPreloader;
...
@SpringBootTest(classes = {
        ...
        /* Cache preloaders */
        WebXmlConfig.class, RestCachingInterceptor.class, WmsLayerPreloader.class, WmsLayersPreloader.class},
        properties = {"stratus.catalog.redis.caching.enable-rest-caching=true", "spring.main.allow-bean-definition-overriding=true"})
public class RedisWMSLayerTest extends WMSLayerTest {
