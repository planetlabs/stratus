...
public class Paths {
    ...
    public static String sidecar(String path, String extension) {
        if (extension == null) {
            return null;
        }
        int last = path.lastIndexOf('.');
    ...
    public static final boolean STRICT_PATH = 
     ...
     * </ul>
     */
    public static final Pattern VALID = Pattern.compile("^[^\\\\]*$");
    /**
     ...
     */
    public static final Pattern WARN = Pattern.compile("^[^:*,\'&?\"<>|]*$");
    /**
     * Set of invalid resource names (currently used to quickly identify relative paths).
     */
    public static final Set<String> INVALID = new HashSet<>(
            Arrays.asList("..", "."));
