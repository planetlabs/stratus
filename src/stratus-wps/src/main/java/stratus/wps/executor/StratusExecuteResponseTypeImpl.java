...
import net.opengis.wps10.impl.ResponseBaseTypeImpl;
 ...
 * <ul>
 *   <li>{@link StratusExecuteResponseTypeImpl#getProcess <em>Process</em>}</li>
 *   <li>{@link StratusExecuteResponseTypeImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link StratusExecuteResponseTypeImpl#getDataInputs <em>Data Inputs</em>}</li>
 *   <li>{@link StratusExecuteResponseTypeImpl#getOutputDefinitions <em>Output Definitions</em>}</li>
 *   <li>{@link StratusExecuteResponseTypeImpl#getProcessOutputs <em>Process Outputs</em>}</li>
 *   <li>{@link StratusExecuteResponseTypeImpl#getServiceInstance <em>Service Instance</em>}</li>
 *   <li>{@link StratusExecuteResponseTypeImpl#getStatusLocation <em>Status Location</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StratusExecuteResponseTypeImpl extends ResponseBaseTypeImpl implements ExecuteResponseType {
    /**
     ...
     * @generated
     */
    protected StratusExecuteResponseTypeImpl() {
        super();
    }
