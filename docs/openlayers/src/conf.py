...
copyright = u'2005-' + str(date.today().year) + u' OpenLayers Contributors'
...
# pixels large.
html_favicon = '../../themes/server_rtd_theme/static/img/openlayers.ico'
...
latex_documents = [
  ('index', 'OpenLayersUserManual.tex', u'OpenLayers User Manual',
   u'OpenLayers', 'manual'),
]
