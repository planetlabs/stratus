...
nohup redis-server --port 6379 &>/dev/null &
nohup redis-server --port 6380 --slaveof 127.0.0.1 6379 &>/dev/null &
nohup redis-server --port 6381 --slaveof 127.0.0.1 6379 &>/dev/null &
